...
public class Conectar {
   ...
   /* public Connection conexao() {
        try {   
            Class.forName("com.mysql.jdbc.Driver");
            conect = DriverManager.getConnection("jdbc:mysql://192.168.0.100/sistem", "cliente", "123");
          //conect = DriverManager.getConnection("jdbc:mysql://192.168.0.100/sistem", "pdv1", "123"); 
        } catch (Exception e) {
    ...
    public static Connection faz_conexao() throws SQLException{      
        try {
         Class.forName("com.mysql.jdbc.Driver");
         return DriverManager.getConnection("jdbc:mysql://192.168.0.100/sistem", "cliente", "123");
         //return DriverManager.getConnection("jdbc:mysql://192.168.0.100/sistem", "pdv1", "123");
